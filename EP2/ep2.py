...
def moveCanhao(direcao, matriz):    
    ...
    Destruido=False         #devolve True se o canhao foi destruido
    if direcao==DIREITA and matriz[LINHA_MAXIMA][COLUNA_MAXIMA]==CANHAO:
        ...
        while j<=COLUNA_MAXIMA and not moveu:
           if matriz[LINHA_MAXIMA][j]==CANHAO and matriz[LINHA_MAXIMA][j+direcao]!=LASER_NAVE:
               matriz[LINHA_MAXIMA][j]=' '
               matriz[LINHA_MAXIMA][j+direcao]=CANHAO
               moveu=True
           elif matriz[LINHA_MAXIMA][j]==CANHAO and matriz[LINHA_MAXIMA][j+direcao]==LASER_NAVE:
               matriz[LINHA_MAXIMA][j]=' '
