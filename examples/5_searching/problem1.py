...
jogada = int(
    input("Escolha o metodo de busca (1- busca convencional; 2- busca por sentinela): ")
)
...
if jogada == 2:
    if pertence_sentinela(x, L):
        print(
            "A busca por sentinela indicou que o numero %d APARECE na lista informada"
            % (x)
        )
    else:
        print(
            "A busca por sentinela indicou que o numero %d NÃO aparece na lista informada"
            % (x)
        )
else:
    if not pertence_normal(x, L):
        print(
            "A busca convencional indicou que o numero %d NÃO aparece na lista informada"
            % (x)
        )
    else:
        print(
            "A busca convencional indicou que o numero %d APARECE na lista informada"
            % (x)
        )
