...
def run_tests():
    ...
    try:
        ...
        for i in range(5):
            ...
            assert (
                type(keep_id) is int
            ), "Tipo não é inteiro, verifique se seu\ncarrega_identificador não está retornando float ou str"
            assert (
                keep_id == data["test_02_00_{:02}A".format(i)]
            ), "Falhou na comparação de resultados do test_02_00_{:02}".format(i)
            print("OK")
            test_results += 1
        # carrega_imagem
        ...
        for i in range(5):
            ...
            assert (
                type(keep_id) is list
            ), "Tipo não é lista, verifique se seu\ncarrega_imagem não está retornando float ou str"
            for j in range(len(keep_id)):
                for k in range(len(keep_id[0])):
                    assert (
                        type(keep_id[j][k]) is int
                    ), "Tipo do elemento não é int, verifique se seu\ncarrega_imagem não está retornando float ou str"
            assert (
                keep_id == data["test_02_01_{:02}A".format(i)]
            ), "Falhou na comparação de resultados do test_02_01_{:02}".format(i)
            print("OK")
            test_results += 1
        # salva_imagem
        ...
        for i in range(2):
            ...
            keep_index = i
            salva_imagem(
                data["test_02_02_{:02}D1".format(i)],
                data["test_02_02_{:02}D2".format(i)],
            )
            ...
            assert (
                keep_id == data["test_02_02_{:02}A".format(i)]
            ), "Falhou na comparação de resultados do test_02_02_{:02}".format(i)
            print("OK")
            test_results += 1
            ...
            for trans in keep_id:
                for j in range(len(trans)):
                    for k in range(len(trans[0])):
                        assert (
                            type(trans[j][k]) is int
                        ), "Tipo do elemento não é int, verifique se seu\ncarrega_transformações não está retornando float ou str"
            assert (
                keep_id == data["test_02_03_{:02}A".format(i)]
            ), "Falhou na comparação de resultados do test_02_03_{:02}".format(i)
            print("OK")
            test_results += 1
        ...
        if testing_now == "salva_imagem":
            print(
                "OU sua função não conseguiu salvar/abrir no arquivo de teste: {0}".format(
                    data["test_02_02_{:02}D1".format(i)]
                )
            )
            print("Verifique se você tem permissão de escrita na pasta e/ou ")
            print(
                "se sua função está usando corretamente o nome do arquivo passado via parâmetro"
            )
        print("#####################################")
        ...
        if testing_now == "data.p":
            ...
            print(
                "Para o arquivo: {0}".format(
                    data["test_02_00_{:02}D".format(keep_index)]
                )
            )
            print("################################################")
            print(
                "O resultado esperado era: {0}".format(
                    data["test_02_00_{:02}A".format(keep_index)]
                )
            )
            ...
            print(
                "Para o arquivo: {0}".format(
                    data["test_02_01_{:02}D".format(keep_index)]
                )
            )
            print("################################################")
            print(
                "O resultado esperado era: {0}".format(
                    data["test_02_01_{:02}A".format(keep_index)]
                )
            )
            print("O resultado obtido foi: {0}".format(keep_id))
            ...
            print(
                "Para o arquivo: {0}".format(
                    data["test_02_02_{:02}D1".format(keep_index)]
                )
            )
            print("################################################")
            print(
                "O resultado esperado era: {0}".format(
                    data["test_02_02_{:02}A".format(keep_index)]
                )
            )
            print("O resultado obtido foi: {0}".format(keep_id))
        else:
            print(
                "Para o arquivo: {0}".format(
                    data["test_02_03_{:02}D".format(keep_index)]
                )
            )
            print("################################################")
            print(
                "O resultado esperado era: {0}".format(
                    data["test_02_03_{:02}A".format(keep_index)]
                )
            )
            print("O resultado obtido foi: {0}".format(keep_id))
        print("################################################")
        ...
        print(
            "Você obteve {0} acertos de um total de {1} possíveis".format(
