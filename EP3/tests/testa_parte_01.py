...
def run_tests():
    ...
    try:
        ...
        for i in range(5):
            ...
            assert type(keep_id) is int, 'Tipo n�o � inteiro, verifique se seu calcula_id\nn�o est� retornando float ou str'
            assert keep_id == data['test_01_{:02}A'.format(i)], 'Falhou na compara��o de resultados do test_01_{:02}'.format(i)
            print("OK")
            test_results += 1
    except IOError as e:
        print('FALHOU!')
