...
def run_tests():
    ...
    try:
        ...
        for i in range(5):
            ...
            assert (
                type(keep_id) is int
            ), "Tipo n�o � inteiro, verifique se seu calcula_id\nn�o est� retornando float ou str"
            assert (
                keep_id == data["test_01_{:02}A".format(i)]
            ), "Falhou na compara��o de resultados do test_01_{:02}".format(i)
            print("OK")
            test_results += 1
    except IOError as e:
        print("FALHOU!")
        print("Falhou no teste da fun��o calcula_id!")
        print("#####################################")
        ...
        print("FALHOU!")
        print("Falhou no teste {0} da fun��o calcula_id!".format(keep_index))
        print("################################################")
        print("Para � matriz: {0}".format(data["test_01_{:02}D".format(keep_index)]))
        print("################################################")
        print(
            "O resultado esperado era: {0}".format(
                data["test_01_{:02}A".format(keep_index)]
            )
        )
        ...
        print("#############################################################")
        print("# Parab�ns! Seu c�digo passou em todos os testes da parte01 #")
        print("#############################################################")
        ...
        print(
            "Voc� obteve {0} acertos de um total de {1} poss�veis".format(
