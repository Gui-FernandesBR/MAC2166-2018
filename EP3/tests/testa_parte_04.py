...
def run_tests():
    ...
    try:
        ...
        print("################################################")
        print(
            "Nosso resultado foi: {0}".format(
                data["test_04_{:02}A1".format(keep_index)]
            )
        )
        ...
        print(
            "Identificador esperado: {0}".format(
                data["test_04_{:02}A2".format(keep_index)]
            )
        )
